...
// Bot configuration for WildBot

$ai_config['bot_name'] = "WildBot";
...
$ai_config['noise_multiplier'] = 0.5;          // Percentage of how much to modify each modifier when the bot is created
