...
// Bot configuration for CritterBot

$ai_config['bot_name'] = "CritterBot";
$ai_config['low_creature_threshold'] = 5;    // How many picks deep before considering creatures more
$ai_config['low_creature_proportion'] = 2/3;  // Minimum creature proportion before considering creature more
$ai_config['low_creature_modifier'] = 3;     // Maximum rating modifier (end of pack 3)
