...
// Bot configuration for ColorBot

$ai_config['bot_name'] = "ColorBot";
...
$ai_config['color_threshold'] = 2;            // How many picks deep before considering color more
$ai_config['color_modifier'] = 3.5;            // Maximum additional rating modifier for matching color (top 2 colors)
$ai_config['color_modifier_min'] = 1.5;      // Minimum rating modifier for matching color (top 2 colors)
$ai_config['splashable_modifier'] = 0.1;       // Counteracts color modifier when there is only one off-color mana
...
$ai_config['color_weight'] = 4.5;               // Maximum multiplier for weighting a color's value in regards to avg_pick
