...
// Bot configuration for AggroBot

$ai_config['bot_name'] = "AggroBot";
...
$ai_config['high_mana_curve_avg'] = 2;        // How high the average mana cost must be before valuing cards under 3
$ai_config['high_mana_curve_modifier'] = 3;  // Maximum rating modifier for lower cost spells
$ai_config['high_mana_curve_threshold'] = 10; // How many picks deep before considering cheaper spells more
$ai_config['target_avg_cmc'] = 1.8;           // Cards that deviate from this cmc will be adjusted accordingly
$ai_config['target_avg_cmc_modifier'] = 0.6;   // Multiplied by the cmc difference from the target
$ai_config['creature_modifier'] = 0.5;         // Every spell will be adjusted based on whether it is a creature
