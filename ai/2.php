...
// Bot configuration for FatBot

$ai_config['bot_name'] = "FatBot";
...
$ai_config['low_creature_modifier'] = 2;     // Maximum rating modifier (end of pack 3, lower is stronger)
...
$ai_config['high_mana_curve_avg'] = 6;        // How high the average mana cost must be before valuing cards under 3
$ai_config['high_mana_curve_modifier'] = 2;  // Maximum rating modifier for lower cost spells
$ai_config['high_mana_curve_threshold ']= 30; // How many picks deep before considering cheaper spells more
$ai_config['target_avg_cmc'] = 4.5;           // Cards that deviate from this cmc will be adjusted accordingly
$ai_config['target_avg_cmc_modifier'] = 0.6;   // Multiplied by the cmc difference from the target
...
$ai_config['noise_multiplier'] = 0.2;          // Percentage of how much to modify each variable when the bot is created
