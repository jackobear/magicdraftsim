...
// Bot configuration for RainbowBot

$ai_config['bot_name'] = "RainbowBot";
...
$ai_config['color_modifier'] =2.1;            // Maximum additional rating modifier for matching color (top 2 colors)
$ai_config['color_modifier_min'] = 0.6;      // Minimum rating modifier for matching color (top 2 colors)
...
$ai_config['high_mana_curve_modifier'] = 4;  // Maximum rating modifier for lower cost spells
...
$ai_config['colorless_threshold'] = 6;        // How many picks deep until colorlessness isn't extra valuable
$ai_config['colorless_modifier'] = 1;        // Maximum rating modifier for colorless spells in the first few picks
$ai_config['color_weight'] = 1.5;               // Maximum multiplier for weighting a color's value in regards to avg_pick
